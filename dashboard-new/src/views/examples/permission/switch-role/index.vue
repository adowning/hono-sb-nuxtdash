    ...
    <div class="mb-6">
      <ElCard shadow="never">
        ...
        <div class="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-4">
          <div v-for="account in accounts" :key="account.key" class="p-5 border border-g-400 rounded-lg tad-300" :class="{
            ...
            <div class="text-right">
              <ElButton v-if="currentUser.userName !== account.userName" type="primary" @click="switchRole(account)"
                :loading="switching">
                切换到此角色
              </ElButton>
