...
<script setup lang="ts">
  ...
  defineOptions({ name: 'GameComment' })
  ...
  const clickItem = ref<CommentItem>({
    id: 1,
    date: '2024-9-3',
    content: 'Come on! Learn Node well and write a small demo yourself',
    collection: 5,
    comment: 8,
    userName: 'Anonymous',
    color: COLOR_LIST[0]
  ...
  /**
   * Assign random colors to comment list
   */
