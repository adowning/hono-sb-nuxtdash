...
import { type User as AppUser } from "@backend/src/app"; // Assumes this path is correct
...
const authUser = shallowRef<User | null>(null);
...
export function useAuth() {
  ...
  if (!initialized) {
    initialized = true;
    console.log("listening for auth msgs...");
